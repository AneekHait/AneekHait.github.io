export const site = {
  ...
  tagline: 'Complex data, made clear enough to act on.',
  description:
  ...
  now: 'Building reporting systems at Accenture, writing up analysis methods, and looking for BI work where rigor matters as much as clarity.',
